...
function page() {
    ...
    useEffect(() => {
        ...
        setProjectName(queryParams.project); // Utilisez le nom du projet depuis l'URL
    }, []);
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                setMandatorySections(data.data[0].mandatorySections);
                setBonusSections(data.data[0].bonusSections);
                setGradingOptions(data.data[0].gradingOptions);
                setLoadingSheet(false);
                
            } catch (error) {
                console.error(`Error fetching data for projectName: ${projectName}`, error);
            }
        };
    ...
    const greenColor = 'bg-green-100 text-green-500 hover:bg-green-500 hover:text-white transition duration-200  py-3 px-5 rounded-lg mb-3 flex gap-2 items-center';
    const redColor = 'bg-red-50 text-red-500 hover:bg-red-500 transition duration-200 hover:text-white transition duration-200  py-3 px-5 rounded-lg mb-3 flex gap-2 items-center';
    ...
    useEffect(() => {
        ...
        if (bonusSections && bonusSections.length > 0) {
        let temp = []
        let temp2 = []
    ...
    useEffect(() => {
        ...
        if (mandatorySections && mandatorySections.length > 0) {
        let temp = []
        let temp2 = []
    ...
    useEffect(() => {
        if (mandatorySections && bonusSections) {
        let temp = []
        let temp2 = []
    ...
    return (
        <div className='bg-base-300 text-base-content min-h-screen'>
            ...
            <div className="flex gap-3 items-center max-w-7xl mx-auto pt-10 px-5 2xl:px-0">
                <a href='/'>
                    <button
                        className='w-10 h-10 bg-primary hover:bg-primary-focus text-white py-3 px-3 rounded-full mt-10 transition duration-200'>
            ...
            <div className="max-w-7xl mx-auto pb-20 pt-10 px-5 2xl:px-0">
                ...
                <div className='mt-10 bg-base-100 p-5 lg:p-10 rounded-lg'>
                    ...
                    <div className='space-y-5'> {/* Conteneur avec espacement vertical */}
                ...
                <div className='mt-10 bg-base-100 p-5 lg:p-10 rounded-lg'>
                    ...
                    <div className='pt-5'>
                        {
                            mandatorySections && mandatorySections.length > 0 ? (
                ...
                {
                   bonusSections && bonusSections.length > 0 ? (
                        <div className='mt-10 bg-base-100 p-5 lg:p-10 rounded-lg'>
                            <h2 className='text-2xl font-bold'>
                                Bonus Part
                            </h2>
    ...
    {gradingOptions && gradingOptions.length === 1 ? (
        <div className='pt-10 flex flex-wrap gap-2'>

        {/* Align OK and Outstanding */}
        ...
        {/* Align other buttons in two rows of five */}
...

                {
                    showBackToTop ? (
                        <div className="fixed bottom-0 right-0 p-4">
                            <button
                                onClick={scrollToTop}
                                className="bg-primary hover:bg-primary-focus text-white font-bold py-2 px-4 rounded-full">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
...

                {
                    showBackToTop ? (
                        <div className="fixed top-0 right-0 p-4">
                             <div style={{ zIndex: '99', border: '2px solid white'}} className=' bg-base-200 p-4 rounded-lg shadow-lg'>
                        ...
                        <div style={{ zIndex: '99', border: '2px solid white'}} className='fixed top-16 right-5 bg-base-200 p-4 rounded-lg shadow-lg'>
                                    <div className='text-lg font-bold text-sky-500'>
                                    <span className='text-base-content' >Points : </span>
                                        {
                                            points >= 100 ?
