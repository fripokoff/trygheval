...
export default function AttachmentSection() {
  ...
  return (
    <div className="flex flex-col p-4 lg:p-5 rounded-xl gap-5 mt-10 bg-base-200 attachment-section">
      ...
      {attachments.map((attachment, index) => (
        <div
          key={attachment.id}
          className='mt-2 bg-base-200 p-4 rounded-xl bg-base-300 text-base-content mb-4'
        >
