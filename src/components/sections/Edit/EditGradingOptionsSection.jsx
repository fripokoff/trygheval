...
export default function EditGradingOptionsSection({}) {
  ...
  return (
    <div className="flex flex-col p-4 lg:p-5 rounded-xl gap-5 mt-10 bg-base-200 grading-options">
      ...
      <div 
      className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 w-full gap-4"
      id="grading_options"
      >
          ...
          <div key={id} className="flex flex-col w-full items-center">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                checked={gradingOptions[id]}
                onClick={() => localStorage.setItem("ActiveSection", 'grading_options')}
                onChange={() => updateGradingOption(id, !gradingOptions[id])}
              />
