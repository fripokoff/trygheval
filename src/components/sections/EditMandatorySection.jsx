...
export default function EditMandatorySection({ sheetData, openModal, editMode }) { // Ajout de editMode aux props
  ...
  return (
    <div className="flex flex-col p-4 lg:p-5 rounded-xl gap-5 mt-10 bg-base-300">
      {numberOfMandatorySections === 0 && (<div className="flex justify-between items-center">
      ...
      {mandatorySections.map((section, index) => {
        const isYesNo = yesNo[index] !== undefined ? yesNo[index] : !mandatoryOptionsDataFromServer[index] ? true : mandatoryOptionsDataFromServer[index]?.yes_no === true;
        const isHrEnabled = hrEnabled[index] !== undefined ? hrEnabled[index] : false;
        return (
          <div
            key={section.id}
          ...
          >
            ...
            <div className='flex gap-1 items-center justify-center w-full'>
                <button
                  onClick={() => {}} // Ajoutez ici la logique pour le bouton Yes
                  className='w-full bg-green-500 text-white py-2 px-4 rounded-md hover:bg-green-600'
                >
                  Yes
                </button>
                <button
                  onClick={() => {}} // Ajoutez ici la logique pour le bouton No
            ...
            <label className="relative inline-flex items-center cursor-pointer mr-4">
              ...
              <div className='w-full' style={{ position: 'relative', bottom: '-0.5em' }}>
                <input
            ...
            {isHrEnabled && numberOfMandatorySections > 0 && index < numberOfMandatorySections - 1 && (
